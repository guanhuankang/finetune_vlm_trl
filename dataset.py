...
def format_data(sample):
    system_message = """You are a Vision Language Model specialized in Salient Object Ranking. Detect all salient objects in a scene and rank them from the most to least salient. Output results in this strict JSON format: 
{
    "results": [
        {
            "rank": 1,
        ...
        ...,
        {
            "rank": N,
            "category": "background",
            "message": "No additional salient objects detected.",
        },
    ]
}
Requirements:
